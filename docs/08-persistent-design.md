...
3- Any unexpected errors that might occur that can result in process crashing or req failures should be persisted
...
3- The gateway handles the program existing, by flushing any logs remaining to the persistence store.

Invariant:
1- The persistence store should be up and running for it to work.
